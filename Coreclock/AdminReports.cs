...
namespace Coreclock
{
    public partial class AdminReports : Form
    {
        ...
        {
            new ReportEntry { ID="EMP-001", Name="Juan Dela Cruz",  ReportTitle="Leave Request",        Period="May 1, 2026",  Message="Good day, Admin. I would like to request a leave of absence on May 16, 2026 for personal reasons. I have already coordinated with my team to ensure my tasks are covered. Thank you.", IsRead=false },
            new ReportEntry { ID="EMP-002", Name="Maria Santos",    ReportTitle="Overtime Report",      Period="May 2, 2026",  Message="Hi Admin, I am submitting my overtime report for this week. I rendered 3 extra hours on Monday and 2 extra hours on Wednesday to meet the project deadline. Kindly approve. Thank you.", IsRead=false },
            new ReportEntry { ID="EMP-003", Name="Pedro Garcia",    ReportTitle="Incident Report",      Period="May 2, 2026",  Message="Admin, I am reporting an incident that occurred in the office on May 2. The air conditioning unit in the Finance department malfunctioned and caused a minor water leak. Maintenance has been notified.", IsRead=false },
            new ReportEntry { ID="EMP-004", Name="Anna Reyes",      ReportTitle="Schedule Change",      Period="May 3, 2026",  Message="Hello Admin, I would like to request a schedule change from the regular 8AM-5PM shift to 9AM-6PM starting next week. This is to accommodate my evening classes. Please advise.", IsRead=true },
            new ReportEntry { ID="EMP-005", Name="Mark Villanueva", ReportTitle="Equipment Request",    Period="May 3, 2026",  Message="Dear Admin, my workstation monitor has been flickering for the past two days. I would like to request a replacement monitor so I can continue my work without interruption. Thank you.", IsRead=false },
            new ReportEntry { ID="EMP-006", Name="Grace Mendoza",   ReportTitle="Sick Leave Notice",    Period="May 4, 2026",  Message="Good morning, Admin. I will not be able to report to work today and tomorrow due to illness. I have a medical certificate which I will submit upon my return. Thank you for understanding.", IsRead=true },
            new ReportEntry { ID="EMP-007", Name="Luis Ordonez",    ReportTitle="Project Update",       Period="May 4, 2026",  Message="Hi Admin, just providing an update on the current sprint. We are on track to deliver all tasks by the end of this week. No blockers at the moment. Will keep you posted on any changes.", IsRead=false },
            new ReportEntry { ID="EMP-008", Name="Karla Bautista",  ReportTitle="Tardiness Explanation",Period="May 5, 2026",  Message="Admin, I apologize for my tardiness on May 1 and May 3. There was heavy traffic due to road construction along my route. I will adjust my commute schedule to avoid this in the future.", IsRead=false },
        };
